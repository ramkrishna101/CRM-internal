...
import { fetchTransactions, fetchTransactionOptions, setPage, setLimit } from './transactionsSlice';

const TransactionsPage = () => {
    const dispatch = useDispatch<AppDispatch>();
    const { items, loading, error, total, page, limit, options } = useSelector((state: RootState) => state.transactions);
    ...
    useEffect(() => {
        ...
        // Reset panel when website changes
        if (website) {
            setPanel('');
        }
    }, [dispatch, website]);
